...
def show_fig(fig, filename, width=900, height=None):
    ...
    pio.write_image(fig, path, scale=2, width=width, height=h)
    display(Image(path))
```

See the full live website [here](https://phuonganhdangamy.github.io/jsc370-project/).
...
show_fig(fig, "shap.png", height=500)
```
...
#| echo: false
#| fig-cap: "Genius pageview distributions for modern songs (2010s/2020s). Displayed in log scale to accommodate the wide range of pageviews."
#| fig-format: png
...
show_fig(fig, "nostalgia_log.png", height=430)
```

```{python}
#| label: nostalgia-plot
#| echo: false
#| fig-cap: "Genius pageview distributions for modern songs (2010s/2020s)"
#| fig-format: png
...
show_fig(fig, "nostalgia.png", height=430)
```
